...
const LoginPage = () => {
  ...
  return (
    <div className='min-h-screen bg-cover bg-center flex items-center justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-sm'>
      ...
      <form onSubmit={onSubmitHandler} className='border-2 bg-white/10 backdrop-blur-md text-white border-gray-500 p-6 flex flex-col gap-6 rounded-lg shadow-lg'>
        ...
        <div className='flex flex-col gap-2'>
          {currState==="Sign up" ? (
            ...
            onClick={()=>{setCurrState("Login"); setIsDataSubmitted(false)}} className='font-medium text-violet-500 cursor-pointer'>Login here</
            span></p>
          ) : (
